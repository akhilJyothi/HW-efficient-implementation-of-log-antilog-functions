...
REM
REM Generated by Vivado on Mon Jun 08 15:39:01 +0530 2026
...
echo "xvlog --incr --relax -prj tb_logmain_vlog.prj"
call xvlog  --incr --relax -prj tb_logmain_vlog.prj -log xvlog.log
